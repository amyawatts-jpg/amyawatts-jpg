$(function () {
  ...
  function setup() {
    ...
    createPlatform(300,600, 100, 3000);
    createPlatform(500,500,100,300);
    createPlatform(700,400,100,200);
    createPlatform(900,300,100,200);
    createPlatform(1100,400,100,200);
    createPlatform(1300,500,100,100);
